...
function netSalary() {
  // Variable declaration
      ...
      let deduct_nssf;
      let deduct_nhif;
//Calculates the gross salary/Total income of the individual
      const totalIncome = () => {
          let total = 0;
...
// invokes the nssfDeduction function to provide the correct nssf deductions
      const deductNSSF = () => {
          let deduction = 0;
          if (deduct_nssf) {
...
//invokes the nhifDeduction function to provide the correct nhif deductions
      const deductNHIF = () => {
          let deduction = 0;
          if (deduct_nhif) {
 ...
 // calculates the personal relief
...
//calculates the nhif deductions according to the individual's income
      const nhifDeduction = () => {
          let basicSalary = totalIncome();
          let nhifAmount = 0;
...
// Calculates the tax from the individual's gross salary/total income
...
// calculates the tax on the individual's relief
      const getTaxOffRelief = () => {
          let amount = getTaxOnTaxableIncome() - getPersonalRelief();
          return amount;
      };
// calculates the individual's paye
      const getPAYE = () => {
          let amount = getTaxOnTaxableIncome() - getPersonalRelief();
          return amount;
      };
// calculates the house levy      
      const houseTax = () => {
